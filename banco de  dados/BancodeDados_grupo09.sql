...
('Leticia Costa', 'Costa varejo', 'varejo.costa@outlook.com', '06263-621', 'Rua Magali', 'Limoeiro', 'São Paulo', 'SP', '00.421.719/1009-00', '(11)9919-0000', null, 'Varejo', 'abcdef'),
...
create table dados_arduino (
    ...
    turno varchar(6),
    corredor varchar(30) not null,
    qtd_clientes int not null,
    constraint chk_semana check (dia_semana = 'Segunda' or dia_semana = 'Terça' or dia_semana = 'Quarta' or dia_semana = 'Quinta' or dia_semana = 'Sexta' or dia_semana = 'Sabádo' or dia_semana = 'Domingo'),
	constraint chk_turno check (turno = 'Manhã' or turno = 'Tarde' or turno = 'Noite')
);

-- Leituras de fluxo no Atacado Sams (cliente 1)
insert into dados_arduino (id_cliente, data_leitura, hora_leitura, corredor, qtd_clientes) values
(1, '2025-08-25', '08:00:00', 'Padaria', 35),
(2, '2025-08-25', '10:00:00', 'Hortifruti', 58),
(3, '2025-08-25', '12:00:00', 'Carnes', 72),
(4, '2025-08-25', '14:00:00', 'Frios', 40),
(5, '2025-08-25', '16:00:00', 'Não Perecíveis', 95);
...
(2, 120000.00, 52, 8, 'Bom'),         -- Costa Varejo
